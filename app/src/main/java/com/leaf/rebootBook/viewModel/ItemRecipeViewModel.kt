...
import com.leaf.rebootBook.dataClass.*

class ItemRecipeViewModel {
    ...
    //얼굴 장식
    private val warriorStrFaceDecorationCategory = createAccessoryCategory(listOf(Job.WARRIOR), listOf(Stat.STR), AccessoryType.FACE_DECORATION)
    private val archerDexFaceDecorationCategory = createAccessoryCategory(listOf(Job.ARCHER), listOf(Stat.DEX), AccessoryType.FACE_DECORATION)
    private val thiefLukFaceDecorationCategory = createAccessoryCategory(listOf(Job.THIEF), listOf(Stat.LUK), AccessoryType.FACE_DECORATION)
    private val magicianIntFaceDecorationCategory = createAccessoryCategory(listOf(Job.MAGICIAN), listOf(Stat.INT), AccessoryType.FACE_DECORATION)
    private val pirateMultiFaceDecorationCategory = createAccessoryCategory(listOf(Job.PIRATE), listOf(Stat.STR, Stat.DEX), AccessoryType.FACE_DECORATION)

    //펜던트
    private val warriorStrPendantCategory = createAccessoryCategory(listOf(Job.WARRIOR, Job.PIRATE), listOf(Stat.STR), AccessoryType.PENDANT)
    private val archerDexPendantCategory = createAccessoryCategory(listOf(Job.ARCHER, Job.PIRATE), listOf(Stat.DEX), AccessoryType.PENDANT)
    private val magicianIntPendantCategory = createAccessoryCategory(listOf(Job.MAGICIAN), listOf(Stat.INT), AccessoryType.PENDANT)
    private val thiefLukPendantCategory = createAccessoryCategory(listOf(Job.THIEF), listOf(Stat.LUK), AccessoryType.PENDANT)

    //물약 (공, 마)
    private val enhancedAttakPotion = createPotionCategory(listOf(Job.WARRIOR, Job.ARCHER, Job.THIEF, Job.PIRATE), listOf(Stat.STR, Stat.LUK, Stat.DEX), AlchemyRecipe.ATTACK_MAGIC)
    private val enhancedMagiPotion = createPotionCategory(listOf(Job.MAGICIAN), listOf(Stat.INT), AlchemyRecipe.ATTACK_MAGIC)

    //물약 (주스텟)
    private val enhancedStrPotion = createPotionCategory(listOf(Job.WARRIOR, Job.PIRATE), listOf(Stat.STR), AlchemyRecipe.STAT)
    ...
    val shinyRedWarriorSymbol = ItemRecipe(
        acquisition = listOf(
    ...
    val shinyRedArcherSymbol = ItemRecipe(
        acquisition = listOf(
    ...
    val shinyRedMagicianSymbol = ItemRecipe(
        acquisition = listOf(
    ...
    val shinyRedThiefSymbol = ItemRecipe(
        acquisition = listOf(
    ...
    val shinyRedPirateSymbol = ItemRecipe(
        acquisition = listOf(
    ...
    //펜던트
    val bearsPurplePendant = ItemRecipe(
        acquisition = listOf(
    ...
    val wolfsPurplePendant = ItemRecipe(
        acquisition = listOf(
    ...
    val owlsPurplePendant = ItemRecipe(
        acquisition = listOf(
    ...
    val peacocksPurplePendant = ItemRecipe(
        acquisition = listOf(
    ...
    //5단계 공격력 물약, 향상된 물약
    val enhancedAttackPotion = ItemRecipe(
        acquisition = listOf(
    ...
    val moreEnhancedAttackPotion = ItemRecipe(
        acquisition = listOf(
    ...
    //5단계 마력 물약, 향상된 물약
    val enhancedMagicPotion = ItemRecipe(
        acquisition = listOf(
            Acquisition.NPC(name = "마이스터빌 지뉴")
        ),
        name = "5단계 마력 물약",
    ...
    val moreEnhancedMagicPotion = ItemRecipe(
        acquisition = listOf(
    ...
    //9단계 힘의 물약, 향상된 물약
    val enhencedStrPotion = ItemRecipe(
        acquisition = listOf(
            Acquisition.NPC(name = "마이스터빌 지뉴")
        ),
        name = "9단계 힘의 물약",
    ...
    val moreEnhancedStrPotion = ItemRecipe(
        acquisition = listOf(
    ...
    //9단계 지능의 물약, 향상된 물약
    val enhencedIntPotion = ItemRecipe(
        acquisition = listOf(
            Acquisition.NPC(name = "마이스터빌 지뉴")
        ),
        name = "9단계 지능의 물약",
    ...
    val moreEnhancedIntPotion = ItemRecipe(
        acquisition = listOf(
            Acquisition.Monster(name = "레인디어", level = 118),
    ...
    //10단계 민첩의 물약, 향상된 물약
    val enhencedDexPotion = ItemRecipe(
        acquisition = listOf(
            Acquisition.NPC(name = "마이스터빌 지뉴")
        ),
        name = "10단계 민첩의 물약",
    ...
    val moreEnhancedDexPotion = ItemRecipe(
        acquisition = listOf(
    ...
    //10단계 행운의 물약, 향상된 물약
    val enhencedLukPotion = ItemRecipe(
        acquisition = listOf(
            Acquisition.NPC(name = "마이스터빌 지뉴")
        ),
        name = "10단계 행운의 물약",
    ...
    val moreEnhancedLukPotion = ItemRecipe(
        acquisition = listOf(
